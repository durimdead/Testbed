...
{
    public class AnimalSortBySound : IAnimalSort
    {
        /// <summary>
        ...
        {
            List<Animal> sortedAnimals = CommonEnums.SortOrder.Ascending == sortOrder
                     ? animalsToSort.OrderBy(animal => animal.AnimalSound).ToList()
                     : animalsToSort.OrderByDescending(animal => animal.AnimalSound).ToList();
